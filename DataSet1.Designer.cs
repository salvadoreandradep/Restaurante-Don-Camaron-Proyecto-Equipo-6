...
namespace Semena_6___Parcial_1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class usuariosDataTable : global::System.Data.TypedTableBase<usuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public usuariosRow AddusuariosRow(string usuario, string clave, string nivel) {
...
namespace Semena_6___Parcial_1.DataSet1TableAdapters {
    ...
    public partial class usuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `usuarios` WHERE ((`Id` = ?) AND ((? = 1 AND `usuario` IS NULL) OR (`" +
                "usuario` = ?)) AND ((? = 1 AND `clave` IS NULL) OR (`clave` = ?)) AND ((? = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `usuarios` (`usuario`, `clave`, `nivel`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `usuarios` SET `usuario` = ?, `clave` = ?, `nivel` = ? WHERE ((`Id` = ?) A" +
                "ND ((? = 1 AND `usuario` IS NULL) OR (`usuario` = ?)) AND ((? = 1 AND `clave` IS" +
                " NULL) OR (`clave` = ?)) AND ((? = 1 AND `nivel` IS NULL) OR (`nivel` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Semena_6___Parcial_1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, usuario, clave, nivel\r\nFROM            usuarios";
        ...
        public virtual int Delete(int Original_Id, string Original_usuario, string Original_clave, string Original_nivel) {
        ...
        public virtual int Insert(string usuario, string clave, string nivel) {
            if ((usuario == null)) {
        ...
        public virtual int Update(string usuario, string clave, string nivel, int Original_Id, string Original_usuario, string Original_clave, string Original_nivel) {
            if ((usuario == null)) {
